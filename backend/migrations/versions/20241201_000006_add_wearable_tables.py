...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "source_id",
            sa.Integer(),
            sa.ForeignKey("wearable_sources.id", ondelete="CASCADE"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "source_id",
            sa.Integer(),
            sa.ForeignKey("wearable_sources.id", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.Column(
            "raw_id",
            sa.Integer(),
            sa.ForeignKey("wearable_raw.id", ondelete="SET NULL"),
            nullable=True,
        ),
    ...
    op.create_index(
        "ix_wearable_canonical_steps_user_id", "wearable_canonical_steps", ["user_id"]
    )
    op.create_index(
        "ix_wearable_canonical_steps_source_id",
        "wearable_canonical_steps",
        ["source_id"],
    )
    op.create_index(
        "ix_wearable_canonical_steps_raw_id", "wearable_canonical_steps", ["raw_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_wearable_canonical_hr_user_id", "wearable_canonical_hr", ["user_id"]
    )
    op.create_index(
        "ix_wearable_canonical_hr_source_id", "wearable_canonical_hr", ["source_id"]
    )
    op.create_index(
        "ix_wearable_canonical_hr_raw_id", "wearable_canonical_hr", ["raw_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_wearable_canonical_sleep_sessions_user_id",
        "wearable_canonical_sleep_sessions",
        ["user_id"],
    )
    op.create_index(
        "ix_wearable_canonical_sleep_sessions_source_id",
        "wearable_canonical_sleep_sessions",
        ["source_id"],
    )
    op.create_index(
        "ix_wearable_canonical_sleep_sessions_raw_id",
        "wearable_canonical_sleep_sessions",
        ["raw_id"],
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "session_id",
            sa.Integer(),
            sa.ForeignKey("wearable_canonical_sleep_sessions.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "user_id",
    ...
    op.create_index(
        "ix_wearable_canonical_sleep_stages_session_id",
        "wearable_canonical_sleep_stages",
        ["session_id"],
    )
    op.create_index(
        "ix_wearable_canonical_sleep_stages_user_id",
        "wearable_canonical_sleep_stages",
        ["user_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_wearable_daily_agg_source_id", "wearable_daily_agg", ["source_id"]
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_wearable_sleep_stages_user_start",
        table_name="wearable_canonical_sleep_stages",
    )
    op.drop_index(
        "ix_wearable_canonical_sleep_stages_user_id",
        table_name="wearable_canonical_sleep_stages",
    ...
    op.drop_index(
        "ix_wearable_sleep_sessions_user_start",
        table_name="wearable_canonical_sleep_sessions",
    )
    op.drop_index(
        "ix_wearable_canonical_sleep_sessions_raw_id",
        table_name="wearable_canonical_sleep_sessions",
    ...
    op.drop_index(
        "ix_wearable_canonical_hr_user_timestamp", table_name="wearable_canonical_hr"
    )
    op.drop_index("ix_wearable_canonical_hr_raw_id", table_name="wearable_canonical_hr")
    op.drop_index(
        "ix_wearable_canonical_hr_source_id", table_name="wearable_canonical_hr"
    )
    op.drop_index(
        "ix_wearable_canonical_hr_user_id", table_name="wearable_canonical_hr"
    )
    op.drop_table("wearable_canonical_hr")

    op.drop_index(
        "ix_wearable_canonical_steps_user_start", table_name="wearable_canonical_steps"
    )
    op.drop_index(
        "ix_wearable_canonical_steps_raw_id", table_name="wearable_canonical_steps"
    )
    op.drop_index(
        "ix_wearable_canonical_steps_source_id", table_name="wearable_canonical_steps"
    )
    op.drop_index(
        "ix_wearable_canonical_steps_user_id", table_name="wearable_canonical_steps"
    )
